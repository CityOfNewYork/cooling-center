...
messages.ar = {
	...
	panel_note: '<p>تفتح مدينة نيويورك مراكز تبريد في المرافق العامة المكيفة لاستخدامها من طرف من يتضايقون من موجة الحر.</p><p>للعثور على مركز تبريد، ما عليك سوى كتابة عنوانك أو أسم أقرب تقاطع في حقل البحث في الزاوية العلوية اليسرى من الخريطة ثم الضغط على "إدخال"، أو تكبير الخريطة وتحريكها إلى موقع منطقتك.</p><p>للبحث او لعرض المراكز التي يسهل على ذوي الإعاقة الوصول اليها فقط، انقر على زر "قابل للوصول" في الاسفل. انقر على زر جميع المراكز للعودة الى قائمة كافة المراكز.</p><p>للبحث او لعرض المراكز التي تقبل الحيوانات الاليفة، انقر على زر "الحيوانات الاليفة مقبولة". انقر على زر "جميع المراكز" للعودة الى قائمة كافة المراكز.</p><p><b>ملاحظة:</b> يرجى مراجعة هذا الموقع يوميا. قد تغير مراكز التبريد ساعات العمل.</p><p><a href=\"http://www1.nyc.gov/site/em/ready/extreme-heat.page\" target=\"_blank\">تعرف على المزيد لكي تتمتع بجو بارد.<a></p>',
...
messages.bn = {
	...
	panel_note: '<p>তাপদাহে শারীরিক অস্বাচ্ছন্দ্যের শিকার হওয়া ব্যক্তিদের জন্য নিউ ইয়র্ক সিটি শীতাতপ নিয়ন্ত্রিত সরকারি স্থাপনাগুলোতে কুলিং সেন্টার খুলে থাকে৷</p><p>একটি কুলিং সেন্টার খুঁজে বের করতে, মানচিত্রের উপরে বাম কোণে অনুসন্ধানের ঘরে আপনার ঠিকানা বা ইন্টারসেকশনের নাম লিখুন এবং “Enter” চাপুন; অথবা মানচিত্রে আপনার মহল্লার অবস্থানের জায়গায় জুম ও প্যান করুন৷</p><p>হুইলচেয়ার প্রবেশযোগ্য সেন্টারগুলো খুঁজতে বা দেখতে, নিচের “হুইলচেয়ার প্রবেশযোগ্য” বাটনে ক্লিক করুন; সব কেন্দ্রে ফিরে যেতে “সব কেন্দ্র” অপশনে ক্লিক করুন৷</p><p>পোষা প্রাণী বান্ধব সেন্টারগুলো খুঁজতে বা দেখতে, নিচের “পোষা প্রাণী অনুমোদিত” বাটনে ক্লিক করুন; সব কেন্দ্রে ফিরে যেতে “সব কেন্দ্র” অপশনে ক্লিক করুন৷</p><p><b>দ্রষ্টব্য:</b>অনুগ্রহ করে এই সাইট প্রতিদিন চেক করুন৷ কুলিং সেন্টারগুলো খোলা থাকার সময়সূচি পরিবর্তিত হতে পারে</p><a href=\"http://www1.nyc.gov/site/em/ready/extreme-heat.page\" target=\"_blank\">ঠাণ্ডা থাকার উপায়গুলো সম্পর্কে আরো জানুন৷</a></p>',
	acc_all: "সব সেন্টার",
...
messages.ru = {
	...
	pop_pet: "Допускаются домашние животные",
	day: "День",
	opens: "Открыто",
	closes: "Закрыто",
	closed: "Закрыто",
